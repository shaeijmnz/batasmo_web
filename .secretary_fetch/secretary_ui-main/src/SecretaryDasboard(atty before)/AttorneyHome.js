...
/* ── Icons ── */
const MenuIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#0B0F19" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const ChartIcon = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <line x1="12" y1="2" x2="12" y2="22"/><path d="M17 5H9.5a1.5 1.5 0 0 0-1.5 1.5v12a1.5 1.5 0 0 0 1.5 1.5H17"/><path d="M7 12h10"/>
  </svg>
);
...
function AttorneyHome({ onNavigate, profile }) {
          ...
          {clientRequests.map((request) => (
            <article key={request.id} className="sec-subcard sec-subcard--compact">
              ...
              <div className="sec-subcard__footer">
                ...
                <button className="sec-view-btn">Open Request</button>
              </div>
            </article>
          ))}
        </div>
          ...
          {messages.map((message) => (
            <article key={message.id} className="sec-subcard sec-subcard--compact">
              ...
              <div className="sec-subcard__footer">
                ...
                <button className="sec-view-btn">Reply</button>
              </div>
            </article>
          ))}
        </div>
      ...
      <>
        <div className="sec-hero-grid">
          <div className="sec-welcome">
            <div className="sec-welcome-art" aria-hidden="true" />
        ...
        <div className="sec-stats-grid">
          ...
          <div className="sec-stat-card">
            <div className="sec-stat-icon"><ChartIcon /></div>
            <p className="sec-stat-label">OPERATIONS</p>
            <button className="sec-view-btn">View Summary</button>
          </div>
        </div>
  ...
  return (
    <div className="sec-page">
      {sidebarOpen && <div className="sec-sidebar-overlay" onClick={() => setSidebarOpen(false)} />}

      <aside className={`sec-sidebar ${sidebarOpen ? 'sec-sidebar--open' : ''}`}>
      ...
      <header className="sec-topbar">
        <div className="sec-topbar__left">
          <button className="sec-back-btn" onClick={() => setSidebarOpen(!sidebarOpen)}>
            <MenuIcon />
          </button>
