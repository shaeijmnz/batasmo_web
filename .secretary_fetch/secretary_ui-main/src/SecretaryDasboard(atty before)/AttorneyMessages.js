    ...
    <div className="am-page">
      ...
      <aside className={`am-sidebar ${sidebarOpen ? 'am-sidebar--open' : ''}`}>
        <div className="am-sidebar__logo">
          ...
          <div className="am-brand-text-wrap">
            ...
            <span className="am-brand-sub">Secretary Console</span>
          </div>
        </div>
      ...
      <header className="am-topbar">
        <div className="am-topbar__left">
          ...
          <div className="am-topbar__logo" aria-label="Secretary messages header"></div>
        </div>
        <div className="am-topbar__right">
          <div className="am-topbar__user">
            <span className="am-topbar__user-name">{profile?.full_name || 'Secretary'}</span>
          </div>
          <div className="am-topbar__avatar">{(profile?.full_name || 'ST').split(' ').map(p => p[0]).slice(0, 2).join('').toUpperCase()}</div>
        </div>
      </header>
