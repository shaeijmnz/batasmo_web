  ...
  useEffect(() => {
    ...
    const loadProfile = async () => {
      ...
      try {
        ...
        if (isMounted) setErrorText(error.message || 'Failed to load profile.');
      }
    };
    loadProfile();
      ...
      <aside className={`ap-sidebar ${sidebarOpen ? 'ap-sidebar--open' : ''}`}>
        <div className="ap-sidebar__logo">
          ...
          <div className="ap-brand-text-wrap">
            ...
            <span className="ap-brand-sub">Secretary Console</span>
          </div>
        </div>
      ...
      <header className="ap-topbar">
        <div className="ap-topbar__left">
          ...
          <div className="ap-topbar__logo">
            ...
            <div>
              <p className="ap-topbar__eyebrow">Welcome, Secretary</p>
              ...
              <div className="ap-edit-layout">
                ...
                <section className="ap-edit-panel">
                  <div className="ap-edit-panel__title">
                    ...
                    <span>Fields update the secretary console immediately after save.</span>
                  </div>
